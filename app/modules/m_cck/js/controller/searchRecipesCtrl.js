app.controller('searchRecipesCtrl', ['$scope', '$rootScope', 'dialog', '$state', 'searchRecipesService', 'StorageConfig', function($scope, $rootScope, dialog, $state, searchRecipesService, StorageConfig){
	$scope.header = true;
